...
<?php 
    ...
    if( !empty( $image ) ): ?>
    <header class="header-special" style="background-image: url('<?php echo esc_url($image['url']); ?>'); height:80vh" data-enllax-ratio=".5" data-enllax-direction="vertical">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="text-center col-md-6 mx-auto">
                    <h1 data-aos="fade-up" data-aos-duration="500"><?php echo get_the_title(68); ?></h1>
                    <p class="border-0 p-0" data-aos="fade-up" data-aos-duration="500"><?php echo get_the_content(68); ?></p>
                </div>
            </div>
        </div>
    </header>
